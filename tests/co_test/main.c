...
static void test_1() {
    ...
    Coroutine thd1 = co_start(work, "X");
    Coroutine thd2 = co_start(work, "Y");
...
static void test_2() {
    ...
    Coroutine thd1 = co_start(producer, queue);
    Coroutine thd2 = co_start(producer, queue);
    Coroutine thd3 = co_start(consumer, queue);
    Coroutine thd4 = co_start(consumer, queue);
